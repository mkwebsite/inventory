 ...
 */
	...
	public function generateTreeListChildren(Model $Model, $conditions = null, $keyPath = null, $valuePath = null, $spacer = '_', $recursive = null, $id = null) {
		$options = array();
		if (is_array($id)) {
			$options = $this->_getOptions($id);
			extract(array_merge(array('id' => null), $id));
		...
		if ($left) {
			$conditions[] = array($Model->escapeField($left) . ' <=' => $item[$left]);
		}
		if ($right) {
			$conditions[] = array($Model->escapeField($right) . ' >=' => $item[$right]);
		}
		//return $conditions ;	
	...
	public function generateTreeListChildrenAll(Model $Model, $conditions = null, $keyPath = null, $valuePath = null, $spacer = '_', $recursive = null, $id = null){
		$options = array();
		if (is_array($id)) {
			$options = $this->_getOptions($id);
			extract(array_merge(array('id' => null), $id));
	...
	public function generateTreeListChildrenAll1(Model $Model, $id=null, $direct=false, $fields=null, $order=null, $limit=null, $page=1, $recursive=null){
		$options = array();
		if (is_array($id)) {
			$options = $this->_getOptions($id);
			extract(array_merge(array('id' => null), $id));
