...
<div class="row margin_btm10">
	...
	<div class="col-lg-6">
		<div class="btn-group btn-group-justified"><?php
			echo $this->Html->link($new .' New Order', array('controller'=>'product_solds', 'action'=>'index', 1), array("class"=>"btn btn-success"));
			echo $this->Html->link($packed .' Packed', array('controller'=>'product_solds', 'action'=>'index', 2), array("class"=>"btn btn-default"));
			echo $this->Html->link($dispached .' Dispached', array('controller'=>'product_solds', 'action'=>'index', 3), array("class"=>"btn btn-warning"));
			echo $this->Html->link($delivered .' Delivered', array('controller'=>'product_solds', 'action'=>'index', 4), array("class"=>"btn btn-danger"));
			echo $this->Html->link($all .' All', array('controller'=>'product_solds', 'action'=>'index'), array("class"=>"btn btn-info")); ?>
		</div>
	</div> 
</div>
		...
		<section class="panel">
			...
			<div class="panel-body"><?php
				...
				echo $this->Form->create('ProductSold', array(
					'url'=>array('controller'=>'product_solds', 'action'=>'index', $status), 
					...
					echo $this->Html->link('Show All', array('controller'=>'product_solds', 'action'=>'index'), array('escape'=>false, 'class'=>'btn btn-success'));
				...
				<table class="dataTable table table-striped table-advance table-hover">
					...
					<tbody><?php
						foreach($data as $value){ ?>
							<tr>
								<td><?php echo $this->Html->link($value['ProductSold']['order_sku'], array('controller'=>'product_solds', 'action'=>'view', $value['ProductSold']['id'])); ?></td>
								...
								<td><?php 
									echo $this->Html->link('<i class="fa fa-credit-card"></i>', array('controller'=>'product_solds', 'action'=>'view', $value['ProductSold']['id']), array('escape'=>false)); ?></li>
								</td>
							</tr><?php
						} ?>				  
					</tbody>
