			...
			<div class="col-lg-12">
				<section class="panel">
					<div class="panel-heading">
						...
						echo $this->Html->link('Export PDF', array('controller'=>'sales', 'action'=>'export_pdf'), array('escape'=>false, 'class'=>'btn-sm btn-inverse')).'&nbsp';
						echo $this->Html->link('Export CSV', array('controller'=>'sales', 'action'=>'export_csv'), array('escape'=>false, 'class'=>'btn-sm btn-inverse')).'&nbsp';
						echo $this->Html->link('Export XLS', array('controller'=>'sales', 'action'=>'export_xls'), array('escape'=>false, 'class'=>'btn-sm btn-inverse'));
						?>
						</div>
					</div> 
					...
					<div class="panel-body"><?php
						echo $this->Form->create('Sale', array(
							'url'=>array('controller'=>'sales', 'action'=>'sales_order_history_report'), 
							...
							<div class="form-group" style="width:20%;">
								...
								echo $this->Form->input('status', array('empty'=>'Sales Status','options'=>Configure::read('SalesStatus'), 'div'=>false, "class"=>"form-control", 'value'=>$status, 'label'=>false, 'style'=>'width:100%')); ?>
							</div>&nbsp; <?php
						
							echo $this->Form->submit("Search", array("class"=>"btn btn-info", 'div'=>false)); echo "&nbsp;";
							echo $this->Html->link('Show All', array('controller'=>'sales', 'action'=>'sales_order_history_report'), array('escape'=>false, 'class'=>'btn btn-info'));
							...
							<table class="table m-n">
								<thead>
									<tr>
										...
										<th class="hidden-phone sorting<?php echo ($sort_by=='expected_shipping_date')?'_'.$asc_desc:''; ?>"><span class="m7"><?php echo $this->ExPaginator->sort('Sale.expected_shipping_date', 'Expected Shipment Date'); ?> </span></th>
								...
								<tbody><?php
									...
									foreach($data as $value){ ?>
										<tr>
											...
											<td><?php echo date('M d, Y', strtotime($value['Sale']['expected_shipping_date'])); ?></td>
											...
											$total_amount = $this->General->getTotalAmount($value['Sale']['id']); 
											$all_total_amt += $total_amount;
											?>	
											<td class="hidden-phone">$<?php echo number_format($total_amount,2); ?></td>
										 </tr><?php
									} ?>
									<tr><td colspan="6">Total</td><td>$<?php echo number_format($all_total_amt,2); ?></td></tr>
