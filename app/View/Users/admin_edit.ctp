...
$id 	 = isset($this->params['pass'][1])?$this->params['pass'][1]:''; ?>
...
<div class="container-fluid">   
	<div data-widget-group="group1">   
		...
		echo $this->Form->create('User', 
				array('type' => 'file', 'url' => array('controller' => 'users', 'action' => 'edit', $role_id, $id),
					'inputDefaults' => array(
						'error' => array(
							'attributes' => array(
								'wrap' => 'span',
			...
			echo $this->Form->input('UserBillingAddress.id', array('type'=>'hidden'));
			echo $this->Form->input('UserShippingAddress.id', array('type'=>'hidden'));
			
			echo $this->Form->input('UserBillingAddress.user_id', array('type'=>'hidden'));
			echo $this->Form->input('UserShippingAddress.user_id', array('type'=>'hidden'));?>
