	...
	<div data-widget-group="group1">   
		...
		<div class="col-lg-12 p-n">
			...
			<div class="col-lg-8 pt-lg">
				<div class="btn-group btn-group-justified p-n m-n"><?php
				...
				<section class="panel">
					...
					<div class="panel-body"><?php
							...
							<div class="form-group" style="width:30%;">
								...
								echo $this->Form->input('first_name', array('type'=>'text', 'placeholder'=>'Search Keyword', 'div'=>false, "class"=>"form-control", 'value'=>$keywords, 'label'=>false, 'style'=>'width:100%')); ?>
							</div>&nbsp;<?php
							
							echo $this->Form->submit("Search", array("class"=>"btn btn-info", 'div'=>false)); echo "&nbsp;";
							echo $this->Html->link('Show All', array('controller'=>'users', 'action'=>'index', $role_id, $status), array('escape'=>false, 'class'=>'btn btn-info'));
		...
		<div class="row">
			...
			if($data){
				...
				echo $this->element('Admin/admin_pagination', array("paging_model_name"=>"User", "total_title"=>"Users List"));  } else{ ?> 
