...
echo $this->Form->create('SaleTax', 
		array('type' => 'file', 'url' => array('controller' => 'sale_taxes', 'action' => 'add'),
			'inputDefaults' => array(
				'error' => array(
					'attributes' => array(
						'wrap' => 'span',
		...
		<div class="col-lg-12">
			<section class="panel">
				...
				<div class="panel-body"><?php 
					...
					echo $this->element('Admin/SaleTax/form'); ?>
					...
					<div class="row">
						<div class="col-lg-12"><?php
							...
							<button type="submit" class="btn btn-primary"><i class='fa fa-check-square'></i> Add New Sale Tax </button>
						</div>
					</div>
