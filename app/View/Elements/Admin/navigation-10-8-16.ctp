				...
				<nav role="navigation" class="widget-body">
					<ul class="acc-menu"> 
						...
						<li class="<?php echo $class; ?>"> 
							...
							<ul class="acc-menu active" style="<?php echo ($class)?'display: block;':''; ?>"> 
								<li><?php echo $this->Html->link('Customer Lists', array('controller' => 'users', 'action' => 'index', 3), array('escape' => false)); ?></li>
								<li><?php echo $this->Html->link('Add Customer', array('controller' => 'users', 'action' => 'add', 3), array('escape' => false)); ?></li>
							 </ul>
						</li><?php
