...
<div class="container-fluid">   
	<div data-widget-group="group1">  
		...
		echo $this->Form->create('Product', 
				array('type'=>'file', 'url' => array('controller'=>'products', 'action'=>'edit', $id),
					'inputDefaults' => array(
						'error' => array(
							'attributes' => array(
								'wrap' => 'span',
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-lg-12"><?php
									...
									<button type="submit" class="btn btn-default"><i class='fa fa-check-square'></i> Update Product</button>
								</div>
							</div>
						</div>
					</section>
