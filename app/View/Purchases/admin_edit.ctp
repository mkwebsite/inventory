...
<div class="container-fluid">   
	<div data-widget-group="group1">   
		...
		echo $this->Form->create('Purchase', 
				array('type'=>'file', 'url' => array('controller'=>'purchases', 'action'=>'edit', $id),
					'inputDefaults' => array(
						'error' => array(
							'attributes' => array(
								'wrap' => 'span',
				...
				<div class="col-lg-12">
					<section class="panel">
						...
						<div class="panel-body"><?php 
							echo $this->element('Admin/Purchase/form'); ?> 
							<div class="row">
								<div class="col-lg-12"><?php
									...
									<button type="submit" class="btn btn-default"><i class='fa fa-check-square'></i> Update Purchase</button>
								</div>
							</div> 
						</div>
					</section>
